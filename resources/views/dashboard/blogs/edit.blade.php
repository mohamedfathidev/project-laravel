    ...
    <div class="card-body">
      ...
      <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-12">
          ...
          <input type="text" name="title" class="form-control" id="inputNanme4" value="{{$blog->title}}" required>
        ...
        <div class="col-12">
            ...
            <input type="text" name="author" class="form-control" id="inputNanme4" value="{{$blog->Author}}" required>
        ...
        <div class="col-12">
            ...
            <input type="text" name="author_des" class="form-control" id="inputNanme4" value="{{$blog->Author_des}}">
